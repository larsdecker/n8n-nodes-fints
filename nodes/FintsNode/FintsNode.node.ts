...
export class FintsNode implements INodeType {
	description: INodeTypeDescription = {
			...
			},
      {
				...
				type: 'boolean',
				default: false,
				description: 'Whether to include detailed debug logs in the output. When enabled, adds a _debug property to each output item with step-by-step execution information.',
				displayOptions: {
					show: {
						resource: ['account'],
						operation: ['getStatements'],
